"""scNMT-seq parsed-bundle adapter, promoted from the manuscript notebook.

Source: UniVI_manuscript_GR-Supple_____scNMT-seq_mouse_gastrulation_data.ipynb
at Git commit 8353ec8d422841e756b3abe4e9a5c4286c0c81dd, cells 5,7-13,15.
Display calls are replaced with print; functions otherwise preserve the parser.
For the published proof of concept use require_qc=False, filter_features=False.
The optional pre-split feature filters are transductive; do not enable them when
claiming strictly training-only feature selection.
"""
...
# Source notebook cell 5 (0-based).
...
# Source notebook cell 7 (0-based).
...
# Source notebook cell 8 (0-based).
...
# Source notebook cell 9 (0-based).
...
# Source notebook cell 10 (0-based).
...
# Source notebook cell 11 (0-based).
...
# Source notebook cell 12 (0-based).
...
# Source notebook cell 13 (0-based).
...
# Source notebook cell 15 (0-based).
